 ...
 */
public class JsonPatternInfoSerializationConverter implements Converter<JsonPattern, JsonPatternInfo> {

	/**
	 * 
	 */
	public JsonPatternInfoSerializationConverter() {
	...
	public JsonPatternInfo convert(JsonPattern input) throws JsonException {
		...
		String pattern = input.serializePattern();
