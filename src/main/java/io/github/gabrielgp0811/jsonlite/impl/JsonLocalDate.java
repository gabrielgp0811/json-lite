...
public class JsonLocalDate extends JsonEntry<LocalDate> {
	...
	public JsonLocalDate() {
		this.name = JsonStrings.LOCALDATE_NAME;
	}
	...
	public JsonLocalDate(LocalDate value) {
		super(JsonStrings.LOCALDATE_NAME, value);
	}
	...
	public JsonLocalDate(LocalDate value, String pattern) {
		this(JsonStrings.LOCALDATE_NAME, value, pattern);
	}
	...
	public JsonLocalDate(LocalDate value, String pattern, String locale) {
		super(JsonStrings.LOCALDATE_NAME, value, pattern, locale);
	}
	...
	public JsonLocalDate(LocalDate value, String pattern, String locale, String timezone) {
		super(JsonStrings.LOCALDATE_NAME, value, pattern, locale, timezone);
	}
	 ...
	 */
	public JsonLocalDate(LocalDate value, JsonPatternInfo info) {
		super(JsonStrings.LOCALDATE_NAME, value, info);
	}
	 ...
	 * @param info  The info to set
	 */
	public JsonLocalDate(String name, LocalDate value, JsonPatternInfo info) {
		super(name, value, info);
	}

	@Override
	public JsonEntry<LocalDate> addChild(String name, Object obj, JsonPatternInfo info) {
		return this;
	}
	...
	@Override
	public JsonEntry<LocalDate> clone() {
		return new JsonLocalDate(name, value, info);
	}
