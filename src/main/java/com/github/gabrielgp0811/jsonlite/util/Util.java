 ...
 * 
 */
package com.github.gabrielgp0811.jsonlite.util;
...
public final class Util {
	...
	/**
	 * Checks if <code>json</code> is a <code>JsonBoolean</code>.
	 * 
	 ...
	 *         <strong><span style="color:#7f0055">false</span></strong> otherwise..
	 */
	public static boolean isBoolean(JsonEntry<?> json) {
		return json != null && json instanceof JsonBoolean;
	}
	...
	/**
	 * Checks if <code>json</code> is a <code>JsonCollection</code>.
	 * 
	 * @param json The JSON object.
	 * @return <strong><span style="color:#7f0055">true</span></strong> if is a
	 *         <code>JsonCollection</code>;
	 *         <strong><span style="color:#7f0055">false</span></strong> otherwise.
	 */
	public static boolean isCollection(JsonEntry<?> json) {
		return json != null && json instanceof JsonCollection;
	}
	...
	/**
	 * Checks if <code>json</code> is a <code>JsonDate</code>.
	 * 
	 * @param json The JSON object.
	 * @return <strong><span style="color:#7f0055">true</span></strong> if is a
	 *         <code>JsonDate</code>;
	 *         <strong><span style="color:#7f0055">false</span></strong> otherwise.
	 */
	public static boolean isDate(JsonEntry<?> json) {
		return json != null && json instanceof JsonDate;
	}
	...
	/**
	 * Checks if <code>json</code> is a <code>JsonEnum</code>.
	 * 
	 * @param json The JSON object.
	 * @return <strong><span style="color:#7f0055">true</span></strong> if is a
	 *         <code>JsonEnum</code>;
	 *         <strong><span style="color:#7f0055">false</span></strong> otherwise.
	 */
	public static boolean isEnum(JsonEntry<?> json) {
		return json != null && json instanceof JsonEnum;
	}
	...
	/**
	 * Checks if <code>json</code> is a <code>JsonLocalDate</code>.
	 * 
	 * @param json The JSON object.
	 * @return <strong><span style="color:#7f0055">true</span></strong> if is a
	 *         <code>JsonLocalDate</code>;
	 *         <strong><span style="color:#7f0055">false</span></strong> otherwise.
	 */
	public static boolean isLocalDate(JsonEntry<?> json) {
		return json != null && json instanceof JsonLocalDate;
	}
	...
	/**
	 * Checks if <code>json</code> is a <code>JsonLocalDateTime</code>.
	 * 
	 * @param json The JSON object.
	 * @return <strong><span style="color:#7f0055">true</span></strong> if is a
	 *         <code>JsonLocalDateTime</code>;
	 *         <strong><span style="color:#7f0055">false</span></strong> otherwise.
	 */
	public static boolean isLocalDateTime(JsonEntry<?> json) {
		return json != null && json instanceof JsonLocalDateTime;
	}
	...
	/**
	 * Checks if <code>json</code> is a <code>JsonLocalTime</code>.
	 * 
	 * @param json The JSON object.
	 * @return <strong><span style="color:#7f0055">true</span></strong> if is a
	 *         <code>java.time.LocalTime</code>;
	 *         <strong><span style="color:#7f0055">false</span></strong> otherwise.
	 */
	public static boolean isLocalTime(JsonEntry<?> json) {
		return json != null && json instanceof JsonLocalTime;
	}
	...
	/**
	 * Checks if <code>json</code> is a <code>JsonNumber</code>.
	 * 
	 * @param json The JSON object.
	 * @return <strong><span style="color:#7f0055">true</span></strong> if is a
	 ...
	 *         <strong><span style="color:#7f0055">false</span></strong> otherwise.
	 */
	public static boolean isNumber(JsonEntry<?> json) {
		return json != null && json instanceof JsonNumber;
	}
	...
	/**
	 * Checks if <code>json</code> is a <code>JsonString</code>.
	 * 
	 * @param json The JSON object.
	 * @return <strong><span style="color:#7f0055">true</span></strong> if is a
	 ...
	 *         <strong><span style="color:#7f0055">false</span></strong> otherwise.
	 */
	public static boolean isString(JsonEntry<?> json) {
		return json != null && json instanceof JsonString;
	}

	/**
	 * Checks if <code>json</code> is a <code>JsonObject</code>.
	 * 
	 * @param json The JSON object.
	 * @return <strong><span style="color:#7f0055">true</span></strong> if is a
	 ...
	 *         <strong><span style="color:#7f0055">false</span></strong> otherwise.
	 */
	public static boolean isObject(JsonEntry<?> json) {
		return json != null && json instanceof JsonObject;
	}
	 ...
	 * @return The indent level in tabulation format.
	 */
	public static String getIndentTab(int indentLevel, String tab) {
		if (tab == null)
			tab = JsonStrings.TAB;
